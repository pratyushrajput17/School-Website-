...
const description =
  "Begin your child's journey at Adarsh High School. Learn about our simple admission process, required documents, and how to apply for the upcoming session."
