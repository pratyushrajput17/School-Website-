...
const description =
  "Admissions at Adarsh High School, Sainkheda. Simple admission process for Nursery to Class 10, required documents, and all information for the upcoming session."
