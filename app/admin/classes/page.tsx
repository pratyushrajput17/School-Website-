...
import { Plus, Search, Edit3, Trash2, X, Loader2, Layers } from "lucide-react";
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Create and manage school classes</p>
        </div>
        <Link
      ...
      <div className="bg-white rounded-xl border border-gray-200 mb-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">Add your first class to get started.</p>
          </div>
        ) : (
                ...
                {classes.map((cls) => (
                  <tr key={cls.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      <Link href={`/admin/classes/edit/${cls.id}`} className="text-sm font-medium text-gray-900 hover:text-[#FF9933]">
                        Class {cls.className}
                      </Link>
                    </td>
                    <td className="px-4 py-3">
