...
import { Plus, Search, Edit3, Trash2, X, Loader2, BookOpen } from "lucide-react";
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Create and manage school subjects</p>
        </div>
        <Link
      ...
      <div className="bg-white rounded-xl border border-gray-200 mb-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">Add your first subject to get started.</p>
          </div>
        ) : (
                ...
                {subjects.map((s) => (
                  <tr key={s.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      <Link href={`/admin/subjects/edit/${s.id}`} className="text-sm font-medium text-gray-900 hover:text-[#FF9933]">
                        {s.subjectName}
                      </Link>
                    </td>
                    <td className="px-4 py-3 text-sm text-gray-500">{s.subjectCode || "—"}</td>
                    <td className="px-4 py-3">
