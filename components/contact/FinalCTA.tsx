      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-8 text-3xl font-bold leading-tight tracking-tight text-white sm:text-4xl lg:text-5xl">
            Schedule Your{' '}
            <span className="text-blue-300">Campus Visit</span> Today
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/70">
            Experience {schoolConfig.name} firsthand. Walk through our campus,
            meet our faculty, and discover why we&apos;re the right choice for
            your child&apos;s future.
          </p>
